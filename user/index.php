...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select Account_Number from user where  Username='$uname' && Password='$Password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['aid']=$ret['Account_Number'];
...
<a href="http://localhost/erms/bankindex.php"> <i style='font-size:70px; color:white; padding-left: 1%' class='fab'>&#xf260;</i></a>

  <div class="container">
      <h2 align="center" style="color: white;">Bank Managment System</h2>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <h5> Don't have an account? Click here to <a class="small" href="signup.php"> sign-up</a> </h3>
