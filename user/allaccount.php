...
<body id="page-top">
 ...
 <div class="text-center">
                 <br>   <h1 align="center" style="font-size:25px; class="h4 text-gray-900 mb-4"><b><u><i>My account details</i></b></u></h1>
                  </div>
...
<div class="text-center">
<form  method="post" action="check_useraccount.php">
...
<br> <br> <br><label>ID :   
     ...
     <br> <br>  <img src="195548-OY9OIN-908.jpg" alt="Flowers in Chania" width="400" height="250"><br><br><br>
      </label>
    </form> 
          </div>
