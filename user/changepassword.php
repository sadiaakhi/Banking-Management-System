...
$query=mysqli_query($con,"select Account_Number from user where Account_Number='$Account_Number' and 	Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update user set Password='$newpassword' where Account_Number='$Account_Number'");
