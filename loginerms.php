...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select Email from user where  Account_Number='$anum' && Password='$Password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['aid']=$ret['Email'];
     header('location:Authentication_user.php');
    }
    else{
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
      <h2 align="center" style="color: white; padding-top: 4%">Bank Managment System</h2>
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="">
                    <div class="form-group">
                      <input type="test" class="form-control form-control-user" id="Account_Number" name="Account_Number" aria-describedby="emailHelp" required="true" placeholder="Enter Account_Number ...">
                    </div>
                    <div class="form-group">
