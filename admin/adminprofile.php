...
if(isset($_POST['submit']))
  {
    ...
    $UName=$_POST['UserName'];
     ...
     $query=mysqli_query($con, "update tbladmin set AdminName ='$AName', AdminuserName ='$UName' where ID='$adminid'");
                ...
                <div class="col-4 mb-3">Admin Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="AdminName" name="AdminName" aria-describedby="emailHelp" required="true" value="<?php  echo $row['AdminName'];?>"></div>
                    ...
                    <div class="row">
                     ...
                     <div class="col-8 mb-3">  <input type="text" class="form-control form-control-user"  id="UserName" name="UserName" aria-describedby="emailHelp" value="<?php  echo $row['AdminuserName'];?>"></div>  
                     </div>
